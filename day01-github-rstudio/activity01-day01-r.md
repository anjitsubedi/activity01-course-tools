...
``` r
# Item 1
# Task 1: Adds the values 2 and 5.
result_sum <- 2 + 5
result_sum
```
...
``` r
# Task 2: Creates an R object called `int_vect` that contains the values 1 through 9. 
int_vect <- 1:9
int_vect
```
...
``` r
# Task 3: Creates an R object called `char_vect` that contains the letters "A" through "Q".
...
``` r
# Task 4: Using code, determine how many of the items in `char_vect` occur after the letter "D".
